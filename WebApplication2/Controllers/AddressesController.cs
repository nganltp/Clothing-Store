...
namespace WebApplication2.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(WebApplication2Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("id,customer,detail,phone,isDefaultAddress,isHomeAddress")] Address address)
        {
            if (id != address.id)
            {
                return NotFound();
