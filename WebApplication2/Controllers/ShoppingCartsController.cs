...
namespace WebApplication2.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public ShoppingCartsController(WebApplication2Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("id,customer,created,discard")] ShoppingCart shoppingCart)
        {
